...
export const TOOLS_DATA = {
  ...
  // Code Tools (30+ tools)
  "code-tools": [
    { title: "HTML Formatter", slug: "html-formatter", description: "Format and beautify HTML code" },
    { title: "CSS Formatter", slug: "css-formatter", description: "Format and beautify CSS code" },
    { title: "JavaScript Formatter", slug: "javascript-formatter", description: "Format and beautify JavaScript code" },
    { title: "JSON Formatter", slug: "json-formatter", description: "Format and validate JSON data" },
    { title: "XML Formatter", slug: "xml-formatter", description: "Format and beautify XML code" },
    { title: "SQL Formatter", slug: "sql-formatter", description: "Format SQL queries" },
    { title: "Code Minifier", slug: "code-minifier", description: "Minify HTML, CSS, JavaScript code" },
    { title: "HTML Validator", slug: "html-validator", description: "Validate HTML markup" },
    { title: "CSS Validator", slug: "css-validator", description: "Validate CSS code" },
    { title: "JavaScript Validator", slug: "javascript-validator", description: "Validate JavaScript syntax" },
    { title: "JSON Validator", slug: "json-validator", description: "Validate JSON format" },
    { title: "XML Validator", slug: "xml-validator", description: "Validate XML structure" },
    { title: "Regex Tester", slug: "regex-tester", description: "Test regular expressions" },
    { title: "Code Highlighter", slug: "code-highlighter", description: "Highlight syntax in code" },
    { title: "HTML Encoder", slug: "html-encoder", description: "Encode HTML special characters" },
    { title: "HTML Decoder", slug: "html-decoder", description: "Decode HTML entities" },
    { title: "URL Slug Generator", slug: "url-slug-generator", description: "Generate URL-friendly slugs" },
    { title: "Hash Generator", slug: "hash-generator", description: "Generate MD5, SHA hashes" },
    { title: "UUID Generator", slug: "uuid-generator", description: "Generate unique identifiers" },
    { title: "Password Generator", slug: "password-generator", description: "Generate secure passwords" },
    { title: "Lorem Code Generator", slug: "lorem-code-generator", description: "Generate placeholder code" },
    { title: "Color Code Generator", slug: "color-code-generator", description: "Generate color codes and palettes" },
    { title: "CSS Grid Generator", slug: "css-grid-generator", description: "Generate CSS Grid layouts" },
    { title: "CSS Flexbox Generator", slug: "css-flexbox-generator", description: "Generate CSS Flexbox layouts" },
    { title: "HTML Table Generator", slug: "html-table-generator", description: "Generate HTML tables" },
    { title: "CSS Button Generator", slug: "css-button-generator", description: "Generate CSS buttons" },
    { title: "Meta Tags Generator", slug: "meta-tags-generator", description: "Generate meta tags for HTML" },
    { title: "Robots.txt Generator", slug: "robots-txt-generator-code", description: "Generate robots.txt files" },
    { title: "Htaccess Generator", slug: "htaccess-generator", description: "Generate .htaccess rules" },
    { title: "Favicon Generator", slug: "favicon-generator-code", description: "Generate favicon code" },
    { title: "CSS Animations Generator", slug: "css-animations-generator", description: "Generate CSS animations" },
    { title: "CSS Gradients Generator", slug: "css-gradients-generator", description: "Generate CSS gradients" }
  ],

  // Website Tools (30+ tools)
  "website-tools": [
    { title: "Website Speed Test", slug: "website-speed-test", description: "Test website loading speed" },
    { title: "Mobile Responsive Test", slug: "mobile-responsive-test", description: "Test mobile responsiveness" },
    { title: "Website Downtime Monitor", slug: "website-downtime-monitor", description: "Monitor website uptime" },
    { title: "Domain Whois Lookup", slug: "domain-whois-lookup", description: "Check domain registration info" },
    { title: "DNS Lookup Tool", slug: "dns-lookup-tool", description: "Check DNS records" },
    { title: "Ping Test Tool", slug: "ping-test-tool", description: "Test server response time" },
    { title: "Traceroute Tool", slug: "traceroute-tool", description: "Trace network route to server" },
    { title: "Port Scanner", slug: "port-scanner", description: "Scan open ports on server" },
    { title: "HTTP Headers Checker", slug: "http-headers-checker", description: "Check HTTP response headers" },
    { title: "Website Security Checker", slug: "website-security-checker", description: "Check website security" },
    { title: "SSL Certificate Checker", slug: "ssl-certificate-checker-web", description: "Check SSL certificate status" },
    { title: "Website Carbon Footprint", slug: "website-carbon-footprint", description: "Calculate website environmental impact" },
    { title: "Website Accessibility Checker", slug: "website-accessibility-checker", description: "Check accessibility compliance" },
    { title: "Broken Link Checker", slug: "broken-link-checker-web", description: "Find broken links on website" },
    { title: "Website Screenshot Tool", slug: "website-screenshot-tool", description: "Take website screenshots" },
    { title: "Social Media Checker", slug: "social-media-checker", description: "Check social media presence" },
    { title: "Website Technology Detector", slug: "website-technology-detector", description: "Detect technologies used" },
    { title: "Website Analytics Checker", slug: "website-analytics-checker", description: "Check analytics installation" },
    { title: "Competitor Website Analyzer", slug: "competitor-website-analyzer", description: "Analyze competitor websites" },
    { title: "Website Performance Analyzer", slug: "website-performance-analyzer", description: "Comprehensive performance analysis" },
    { title: "Website SEO Analyzer", slug: "website-seo-analyzer", description: "Analyze website SEO" },
    { title: "Core Web Vitals Checker", slug: "core-web-vitals-checker-web", description: "Check Core Web Vitals" },
    { title: "Website Malware Scanner", slug: "website-malware-scanner", description: "Scan for malware" },
    { title: "Link Analyzer", slug: "link-analyzer", description: "Analyze website links" },
    { title: "Website Structure Analyzer", slug: "website-structure-analyzer", description: "Analyze site structure" },
    { title: "Website Image Analyzer", slug: "website-image-analyzer", description: "Analyze website images" },
    { title: "Website Text Analyzer", slug: "website-text-analyzer", description: "Analyze website content" },
    { title: "Website Load Time Analyzer", slug: "website-load-time-analyzer", description: "Analyze page load times" },
    { title: "Website Server Analyzer", slug: "website-server-analyzer", description: "Analyze server configuration" },
    { title: "Website Database Analyzer", slug: "website-database-analyzer", description: "Analyze database performance" },
    { title: "Website CDN Checker", slug: "website-cdn-checker", description: "Check CDN usage" },
    { title: "Website Compression Checker", slug: "website-compression-checker", description: "Check GZIP compression" }
  ],

  // Writing & Grammar Tools (30+ tools)
  "writing-grammar-tools": [
    ...
    { title: "Passive Voice Detector", slug: "passive-voice-detector", description: "Detect passive voice in text" },
    { title: "Vocabulary Enhancer", slug: "vocabulary-enhancer", description: "Suggest vocabulary improvements" },
    { title: "Tone Analyzer", slug: "tone-analyzer", description: "Analyze text tone and sentiment" },
    { title: "Content Summarizer", slug: "content-summarizer", description: "Summarize long content" },
    { title: "Keyword Extractor", slug: "keyword-extractor", description: "Extract keywords from text" },
    { title: "Title Generator", slug: "title-generator", description: "Generate article titles" },
    { title: "Headline Analyzer", slug: "headline-analyzer", description: "Analyze headline effectiveness" },
    { title: "Content Idea Generator", slug: "content-idea-generator", description: "Generate content ideas" },
    { title: "Blog Post Outline Generator", slug: "blog-post-outline-generator", description: "Generate blog outlines" },
    { title: "Writing Prompt Generator", slug: "writing-prompt-generator", description: "Generate writing prompts" },
    { title: "Synonym Finder", slug: "synonym-finder", description: "Find synonyms for words" },
    { title: "Antonym Finder", slug: "antonym-finder", description: "Find antonyms for words" },
    { title: "Rhyme Finder", slug: "rhyme-finder", description: "Find rhyming words" },
    { title: "Alliteration Generator", slug: "alliteration-generator", description: "Generate alliterative phrases" },
    { title: "Proofreading Tool", slug: "proofreading-tool", description: "Proofread text for errors" },
    { title: "Writing Style Analyzer", slug: "writing-style-analyzer", description: "Analyze writing style" },
    { title: "Cliché Detector", slug: "cliche-detector", description: "Detect clichés in text" },
    { title: "Transition Word Suggester", slug: "transition-word-suggester", description: "Suggest transition words" },
    { title: "Essay Structure Analyzer", slug: "essay-structure-analyzer", description: "Analyze essay structure" },
    { title: "Citation Generator", slug: "citation-generator", description: "Generate academic citations" },
    { title: "Bibliography Generator", slug: "bibliography-generator", description: "Generate bibliographies" },
    { title: "Abstract Generator", slug: "abstract-generator", description: "Generate research abstracts" },
    { title: "Conclusion Generator", slug: "conclusion-generator", description: "Generate conclusions" },
    { title: "Thesis Statement Generator", slug: "thesis-statement-generator", description: "Generate thesis statements" },
    { title: "Paraphrasing Tool", slug: "paraphrasing-tool", description: "Paraphrase text content" }
  ],

  // AI Tools (30+ tools)
  "ai-tools": [
    { title: "AI Text Generator", slug: "ai-text-generator", description: "Generate text using AI" },
    { title: "AI Content Writer", slug: "ai-content-writer", description: "Write content with AI assistance" },
    { title: "AI Article Generator", slug: "ai-article-generator", description: "Generate articles using AI" },
    { title: "AI Blog Post Generator", slug: "ai-blog-post-generator", description: "Generate blog posts with AI" },
    { title: "AI Product Description Generator", slug: "ai-product-description-generator", description: "Generate product descriptions" },
    { title: "AI Meta Description Generator", slug: "ai-meta-description-generator", description: "Generate meta descriptions with AI" },
    { title: "AI Email Generator", slug: "ai-email-generator", description: "Generate emails using AI" },
    { title: "AI Social Media Post Generator", slug: "ai-social-media-post-generator", description: "Generate social media posts" },
    { title: "AI Headline Generator", slug: "ai-headline-generator", description: "Generate headlines with AI" },
    { title: "AI Slogan Generator", slug: "ai-slogan-generator", description: "Generate slogans using AI" },
    { title: "AI Name Generator", slug: "ai-name-generator", description: "Generate names with AI" },
    { title: "AI Story Generator", slug: "ai-story-generator", description: "Generate stories using AI" },
    { title: "AI Poem Generator", slug: "ai-poem-generator", description: "Generate poems with AI" },
    { title: "AI Code Generator", slug: "ai-code-generator", description: "Generate code using AI" },
    { title: "AI SQL Query Generator", slug: "ai-sql-query-generator", description: "Generate SQL queries with AI" },
    { title: "AI Regex Generator", slug: "ai-regex-generator", description: "Generate regex patterns with AI" },
    { title: "AI Translation Tool", slug: "ai-translation-tool", description: "Translate text using AI" },
    { title: "AI Text Summarizer", slug: "ai-text-summarizer", description: "Summarize text with AI" },
    { title: "AI Sentiment Analyzer", slug: "ai-sentiment-analyzer", description: "Analyze sentiment using AI" },
    { title: "AI Keyword Generator", slug: "ai-keyword-generator", description: "Generate keywords with AI" },
    { title: "AI Tag Generator", slug: "ai-tag-generator", description: "Generate tags using AI" },
    { title: "AI Category Generator", slug: "ai-category-generator", description: "Generate categories with AI" },
    { title: "AI FAQ Generator", slug: "ai-faq-generator", description: "Generate FAQs using AI" },
    { title: "AI Quiz Generator", slug: "ai-quiz-generator", description: "Generate quizzes with AI" },
    { title: "AI Question Generator", slug: "ai-question-generator", description: "Generate questions using AI" },
    { title: "AI Answer Generator", slug: "ai-answer-generator", description: "Generate answers with AI" },
    { title: "AI Comment Generator", slug: "ai-comment-generator", description: "Generate comments using AI" },
    { title: "AI Review Generator", slug: "ai-review-generator", description: "Generate reviews with AI" },
    { title: "AI Testimonial Generator", slug: "ai-testimonial-generator", description: "Generate testimonials using AI" },
    { title: "AI Bio Generator", slug: "ai-bio-generator", description: "Generate bios with AI" },
    { title: "AI Resume Generator", slug: "ai-resume-generator", description: "Generate resumes using AI" },
    { title: "AI Cover Letter Generator", slug: "ai-cover-letter-generator", description: "Generate cover letters with AI" }
  ],

  // Math & Calculation Tools (30+ tools)
  "math-calculation-tools": [
    { title: "Basic Calculator", slug: "basic-calculator", description: "Perform basic mathematical operations" },
    { title: "Scientific Calculator", slug: "scientific-calculator", description: "Advanced scientific calculations" },
    { title: "Percentage Calculator", slug: "percentage-calculator", description: "Calculate percentages" },
    { title: "Fraction Calculator", slug: "fraction-calculator", description: "Calculate with fractions" },
    { title: "Algebra Calculator", slug: "algebra-calculator", description: "Solve algebraic equations" },
    { title: "Trigonometry Calculator", slug: "trigonometry-calculator", description: "Calculate trigonometric functions" },
    { title: "Statistics Calculator", slug: "statistics-calculator", description: "Calculate statistical values" },
    { title: "Matrix Calculator", slug: "matrix-calculator", description: "Perform matrix operations" },
    { title: "Geometry Calculator", slug: "geometry-calculator", description: "Calculate geometric shapes" },
    { title: "Area Calculator", slug: "area-calculator", description: "Calculate area of shapes" },
    { title: "Volume Calculator", slug: "volume-calculator", description: "Calculate volume of objects" },
    { title: "BMI Calculator", slug: "bmi-calculator", description: "Calculate Body Mass Index" },
    { title: "Mortgage Calculator", slug: "mortgage-calculator", description: "Calculate mortgage payments" },
    { title: "Loan Calculator", slug: "loan-calculator", description: "Calculate loan payments" },
    { title: "Interest Calculator", slug: "interest-calculator", description: "Calculate compound interest" },
    { title: "Tax Calculator", slug: "tax-calculator", description: "Calculate taxes" },
    { title: "Tip Calculator", slug: "tip-calculator", description: "Calculate tips and split bills" },
    { title: "Age Calculator", slug: "age-calculator", description: "Calculate age in years, months, days" },
    { title: "Date Calculator", slug: "date-calculator", description: "Calculate date differences" },
    { title: "Time Calculator", slug: "time-calculator", description: "Calculate time differences" },
    { title: "GCD Calculator", slug: "gcd-calculator", description: "Calculate Greatest Common Divisor" },
    { title: "LCM Calculator", slug: "lcm-calculator", description: "Calculate Least Common Multiple" },
    { title: "Prime Number Checker", slug: "prime-number-checker", description: "Check if number is prime" },
    { title: "Fibonacci Generator", slug: "fibonacci-generator", description: "Generate Fibonacci sequence" },
    { title: "Random Number Generator", slug: "random-number-generator", description: "Generate random numbers" },
    { title: "Square Root Calculator", slug: "square-root-calculator", description: "Calculate square roots" },
    { title: "Power Calculator", slug: "power-calculator", description: "Calculate powers and exponents" },
    { title: "Logarithm Calculator", slug: "logarithm-calculator", description: "Calculate logarithms" },
    { title: "Factorial Calculator", slug: "factorial-calculator", description: "Calculate factorials" },
    { title: "Combination Calculator", slug: "combination-calculator", description: "Calculate combinations" },
    { title: "Permutation Calculator", slug: "permutation-calculator", description: "Calculate permutations" },
    { title: "Binary Calculator", slug: "binary-calculator", description: "Calculate in binary system" }
  ]
};
